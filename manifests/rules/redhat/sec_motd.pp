...
#
# The contents of the /etc/motd file are displayed to users after login and function as a message of the day for 
# authenticated users.
# Unix-based systems have typically displayed information about the OS release and patch level upon logging in to 
# the system. This information can be useful to developers who are developing software for a particular OS platform. 
# If mingetty(8) supports the following options, they display operating system information: \m - machine 
# architecture \r - operating system release \s - operating system name \v - operating system version
#
# Rationale:
...
#
# @example
#   class security_baseline::rules::redhat::sec_motd {
#       enforce => true,
#       message => 'Test',
#       log_level => 'info'
#   }
