...
describe 'security_baseline::rules::common::sec_ip6tables_outbound_established' do
    ...
    enforce_options.each do |enforce|
      context "on #{os}" do
        ...
        let(:params) do
          {
            'enforce' => enforce,
            'message' => 'ip6tables outbound established policies',
            'log_level' => 'warning',
          }
        end
        ...
        it {
          ...
          if enforce
            ...
            is_expected.not_to contain_echo('ip6tables-outbound-established')
          else
            ...
            is_expected.to contain_echo('ip6tables-outbound-established')
              .with(
                'message'  => 'ip6tables outbound established policies',
                'loglevel' => 'warning',
                'withpath' => false,
