...
describe 'security_baseline::rules::common::sec_iptables_outbound_established' do
    ...
    enforce_options.each do |enforce|
      context "on #{os}" do
        ...
        let(:params) do
          {
            'enforce' => enforce,
            'message' => 'iptables outbound established policies',
            'log_level' => 'warning',
          }
        end
        ...
        it {
          ...
          if enforce
            ...
            is_expected.not_to contain_echo('iptables-outbound-established')
          else
            ...
            is_expected.to contain_echo('iptables-outbound-established')
              .with(
                'message'  => 'iptables outbound established policies',
                'loglevel' => 'warning',
                'withpath' => false,
