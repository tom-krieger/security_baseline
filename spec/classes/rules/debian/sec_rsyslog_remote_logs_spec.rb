...
describe 'security_baseline::rules::debian::sec_rsyslog_remote_logs' do
  enforce_options.each do |enforce|
    context "on Debian with enforce = #{enforce} with remote log host" do
    ...
    context "on Debian with enforce = #{enforce} without remote log host" do
      let(:pre_condition) do
        <<-EOF
        exec { 'reload-rsyslog':
