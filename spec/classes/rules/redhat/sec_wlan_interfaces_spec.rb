...
describe 'security_baseline::rules::redhat::sec_wlan_interfaces' do
  enforce_options.each do |enforce|
    context "on RedHat with enforce = #{enforce} without nmcli" do
      let(:facts) do
        {
          osfamily: 'RedHat',
    ...
    context "on RedHat with enforce = #{enforce} with nmcli" do
      let(:facts) do
        {
          osfamily: 'RedHat',
          operatingsystem: 'CentOS',
